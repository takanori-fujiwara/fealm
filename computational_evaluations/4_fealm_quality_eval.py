...
if __name__ == '__main__':
    ...
    for form in forms:
        for m in ms:
            ...
            for n_iter in n_iters:
                for population_size in population_sizes:
                    ...
                    for trial in range(n_repeats):
                        ...
                        Gs = [G1]
                        gd_prerpcessed_data = [{'S1': S1, 'sig1': sig1}]
            ...
            opt_n_iters = 40
            opt_population_size = 3200
            form_and_sizes_optimal = {}
            form_and_sizes_optimal[form] = {
                'population_size': population_size,
                'n_results': 1,
                'result_selection': 'random'
            }
            fealm_optimal = FEALM(n_neighbors=k,
                                  ...
                                  pso_niter=n_iter,
                                  pso_njobs=n_jobs,
                                  form_and_sizes=form_and_sizes_optimal)
            for trial in range(n_repeats):
